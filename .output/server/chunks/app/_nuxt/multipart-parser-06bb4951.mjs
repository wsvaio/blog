import { e as dr, f as wn } from '../server.mjs';
import 'vue';
import 'node:http';
import 'node:https';
import 'node:zlib';
...
--` + a;
  ...
  write(a) {
    let n = 0;
    const r = a.length;
    let d = this.index, { lookbehind: l, boundary: c, boundaryChars: H, index: e, state: i, flags: A } = this;
    const p = this.boundary.length, O = p - 1, y = a.length;
    let o, L;
    const f = E((h) => {
      this[h + "Mark"] = n;
    }, "mark"), s = E((h) => {
...
async function Z(u, a) {
  ...
  f.decode(), r.onPartBegin = function() {
    ...
    if (l += f.decode(), d = d.toLowerCase(), d === "content-disposition") {
      ...
      s && (H = s[2] || s[3] || ""), i = v(l), i && (r.onPartData = y, r.onPartEnd = o);
    } else
      d === "content-type" && (e = l);
    l = "", d = "";
  };
...
//# sourceMappingURL=multipart-parser-06bb4951.mjs.map
