...
<template>
  <div class="vtextarea">
    <textarea v-model="modelValue" :placeholder="placeholder" rows="10" :="textarea" />
    ...
    <popup pos="!absolute" left="0" bottom="0" p=".5em">
      <template #popuper>
        <ul grid="~ cols-[repeat(12,1fr)]" m="0" p=".5em" gap=".25em" class="card" list="none" bg="[var(--bg-color)]">
