    ...
    ((r.prototype.getModelMatrix = function () {
      ...
      (r.prototype.loadModelData = function (t, i) {
        ...
        e.loadLive2DModel(t, function (t) {
          if (((r.live2DModel = t), r.live2DModel.saveParam(), 0 != Live2D.getError()))
      ...
      (o.loadJson = function (t) {
        ...
        if (
          (i.setFadeIn(parseInt(r.fade_in) > 0 ? parseInt(r.fade_in) : 1e3),
        ...
        for (var a = 0; a < _; a++) {
          ...
          if (
            (u = "add" === p ? o.TYPE_ADD : "mult" === p ? o.TYPE_MULT : "set" === p ? o.TYPE_SET : o.TYPE_ADD) ==
            o.TYPE_ADD
          ) {
        ...
        for (var n = this.paramList.length - 1; n >= 0; --n) {
          ...
          s.type == o.TYPE_ADD
            ...
            : s.type == o.TYPE_MULT
              ...
              : s.type == o.TYPE_SET && t.setParamFloat(s.id, s.value, e);
        }
      }),
    ...
    ((g.STATE_FIRST = "STATE_FIRST"),
      ...
      (f.prototype.adjustScale = function (t, i, e) {
        ...
        r < this.min
          ...
          : r > this.max && this.tr[0] > 0 && (e = this.max / this.tr[0]);
  ...
  function (t, i, e) {
    ...
    function u(t) {
      ...
      (w.default.DEBUG_MOUSE_LOG &&
        console.log("onMouseMove device( x:" + t.clientX + " y:" + t.clientY + " ) view( x:" + n + " y:" + s + ")"),
        (k = e),
        (V = r),
        N.setPoint(n, s));
    }
    function p(t) {
      ...
      var i = C.getBoundingClientRect(),
        ...
        s = T(o.y - i.top);
      (w.default.DEBUG_MOUSE_LOG &&
        console.log("onMouseDown device( x:" + t.clientX + " y:" + t.clientY + " ) view( x:" + n + " y:" + s + ")"),
        (k = e),
        (V = r),
        R.tapEvent(n, s));
    }
    ...
    (function (t) {
      !(function () {
        ...
        ((i._$0s = 1),
          ...
          (i._$62 = function (t, e) {
            try {
              if ((e instanceof ArrayBuffer && (e = new DataView(e)), !(e instanceof DataView)))
              ...
              if (((r = o._$ST()), o._$gr(r), r > G._$T7)) {
                t._$NP |= i._$4s;
                throw new lt(
                  "_$gi _$C _$li , _$n0 _$_ version _$li ( SDK : " + G._$T7 + " < _$f0 : " + r + " )@_$SS#loadModel()\n"
                );
              }
              var h = o._$nP();
              if (r >= G._$s7) {
          ...
          (e.prototype.getMaskRenderTexture = function () {
            var t = null;
            return (
              (t = this.dp_webgl.createFramebuffer()), (at.frameBuffers[this.dp_webgl.glno] = t), this.dp_webgl.glno
            );
          }),
          ...
          (e.prototype.calcClippedDrawTotalBounds = function (t, i) {
            for (
              ...
              if (p._$yo()) {
                for (
                  var f = p.getTransformedPoints(), c = f.length, d = [], g = [], y = 0, m = U._$i2;
                  m < c;
                  m += U._$No
                )
                  ((d[y] = f[m]), (g[y] = f[m + 1]), y++);
          ...
          (s.prototype.updateParam = function (t, i) {
            if (i._$AT && !i._$9L) {
              ...
              ((o =
                o *
                (0 == this._$dP ? 1 : ht._$r2((e - i._$bs) / this._$dP)) *
                (0 == this._$eo || i._$Do < 0 ? 1 : ht._$r2((i._$Do - e) / this._$eo))),
        ...
        ((It._$ni = function (t, i, e, r, o, n, s, _, a) {
          ...
          (v._$br = function (t, i, e, r) {
            ...
            if (3 == o) {
              var p = r[n[0]],
                ...
                P = s[2];
              return (
                (1 - P) * ((1 - u) * (p + (f - p) * h) + u * (c + (d - c) * h)) +
                P * ((1 - u) * (g + (y - g) * h) + u * (m + (T - m) * h))
              );
            }
            if (4 == o) {
              var S = r[n[0]],
              ...
              return (
                (1 - B) *
                  ((1 - P) * ((1 - u) * (S + (v - S) * h) + u * (L + (M - L) * h)) +
                    P * ((1 - u) * (E + (A - E) * h) + u * (I + (w - I) * h))) +
                B *
                  ((1 - P) * ((1 - u) * (x + (O - x) * h) + u * (D + (R - D) * h)) +
                    P * ((1 - u) * (b + (F - b) * h) + u * (C + (N - C) * h)))
              );
            }
          ...
          (D.prototype._$Q2 = function (t, i) {
            for (var e, r, o = this._$Ob.length, n = t._$v2(), s = 0, _ = 0; _ < o; _++) {
              var a = this._$Ob[_];
              if (
                ((e = a.getParamIndex(n)), e == x._$ds && ((e = t.getParamIndex(a.getParamID())), a._$Pb(e, n)), e < 0)
              )
              ...
              if (r < 1);
                ...
                ((l = u[0]), l - U._$J < h && h < l + U._$J ? ((p = 0), (f = 0)) : ((p = 0), (i[0] = !0)));
            ...
            0 == this._$H && 0 == this._$f
              ? 1 == this._$7 && 1 == this._$g
                ? 0 == this._$k && 0 == this._$w
                  ? ((this._$hi = F.STATE_IDENTITY), (this._$Z = F._$pS))
                  : ((this._$hi = F._$gb), (this._$Z = F._$hb))
                : 0 == this._$k && 0 == this._$w
                  ? ((this._$hi = F._$fo), (this._$Z = F._$kS))
                  : ((this._$hi = F._$fo | F._$gb), (this._$Z = F._$kS))
              : 0 == this._$7 && 0 == this._$g
                ? 0 == this._$k && 0 == this._$w
                  ? ((this._$hi = F._$go), (this._$Z = F._$kS))
                  : ((this._$hi = F._$go | F._$gb), (this._$Z = F._$kS))
                : 0 == this._$k && 0 == this._$w
                  ? ((this._$hi = F._$go | F._$fo), (this._$Z = F._$kS))
                  : ((this._$hi = F._$go | F._$fo | F._$gb), (this._$Z = F._$kS));
          }),
              ...
              if ("\n" != n && "\r" != n)
                if ("#" != n)
                  if ("$" != n) {
                    if (("a" <= n && n <= "z") || ("A" <= n && n <= "Z") || "_" == n) {
                      ...
                      if (_ >= 0) {
                        ...
                        (O.startsWith(t, s, C._$cs)
                          ? ((a._$RP = B._$hs), (a._$4P = new String(t, s, _ - s)))
                          : O.startsWith(t, s, C._$ar)
                            ? ((a._$4P = new String(t, s + 7, _ - s - 7)),
                              O.startsWith(t, s + 7, "ANCHOR_X")
                                ? (a._$RP = B._$xs)
                                : O.startsWith(t, s + 7, "ANCHOR_Y")
                                  ? (a._$RP = B._$us)
                                  : O.startsWith(t, s + 7, "SCALE_X")
                                    ? (a._$RP = B._$qs)
                                    : O.startsWith(t, s + 7, "SCALE_Y")
                                      ? (a._$RP = B._$Ys)
                                      : O.startsWith(t, s + 7, "X")
                                        ? (a._$RP = B._$ws)
                                        : O.startsWith(t, s + 7, "Y") && (a._$RP = B._$Ns))
                            : ((a._$RP = B._$Fr), (a._$4P = new String(t, s, _ - s))),
                          i.motions.push(a));
                        var h = 0;
                    ...
                    if (_ >= 0)
                      for (
                        _ == s + 4 && "f" == t[s + 1] && "p" == t[s + 2] && "s" == t[s + 3] && (u = !0), o = _ + 1;
                        o < r && "\r" != (n = 255 & t[o]) && "\n" != n;
                        ++o
                      )
                        if ("," != n && " " != n && "\t" != n) {
          ...
          (C.prototype.updateParamExe = function (t, i, e, r) {
            for (
              var o = i - r._$z2, n = (o * this._$D0) / 1e3, s = 0 | n, _ = n - s, a = 0;
        ...
        ((Y._$V2 = -1),
          ...
          (Y.prototype.init = function () {
            ...
            for (
              var t = this._$Ri.getModelImpl(), i = t._$Xr(), r = i.length, o = new Array(), n = new Array(), s = 0;
              s < r;
              ++s
            ) {
              var _ = i[s];
            ...
            for (var d = o.length, g = yt._$2o(); ; ) {
              for (var y = !1, s = 0; s < d; ++s) {
                ...
                if (null != m) {
                  ...
                  (null == T || T == g || this.getBaseDataIndex(T) >= 0) &&
                    (this._$3S.push(m), this._$db.push(n[s]), (o[s] = null), (y = !0));
                }
              }
              if (!y) break;
            }
          ...
          (Y.prototype.update = function () {
            ...
            (null == this._$Ws || this._$Ws.length < s) &&
              ((this._$Ws = new Int16Array(s)), (this._$Vs = new Int16Array(s)));
            ...
            switch (this._$_L) {
              case STATE_CLOSING:
                ((r = (e - this._$bb) / this._$Dr),
                  r >= 1 && ((r = 1), (this._$_L = wt.STATE_CLOSED), (this._$bb = e)),
                  (i = 1 - r));
                break;
              case STATE_CLOSED:
                ((r = (e - this._$bb) / this._$Cb),
                  r >= 1 && ((this._$_L = wt.STATE_OPENING), (this._$bb = e)),
                  (i = 0));
                break;
              case STATE_OPENING:
                ((r = (e - this._$bb) / this._$mr),
                  r >= 1 && ((r = 1), (this._$_L = wt.STATE_INTERVAL), (this._$12 = this._$T2())),
                  (i = r));
                break;
              case STATE_INTERVAL:
        ...
        ((wt.STATE_FIRST = "STATE_FIRST"),
          ...
          (X._$cr = function (t, i) {
            return (
              null == t || t._$yL() < i.length
                ? ((t = X._$9r(2 * i.length)), t.put(i), t._$oT(0))
          ...
          (X._$mb = function (t, i) {
            return (
              null == t || t._$yL() < i.length
                ? ((t = X._$vb(2 * i.length)), t.put(i), t._$oT(0))
                : (t.clear(), t.put(i), t._$oT(0)),
              t
            );
          }),
          ...
          (z.prototype._$2b = function (t, i) {
            ...
            if ((e._$hS(!0), this._$32())) {
              ...
              if ((e._$8r == I._$ur && (e._$8r = t.getBaseDataIndex(r)), e._$8r < 0))
                (at._$so && _._$li("_$L _$0P _$G :: %s", r), e._$hS(!1));
              else {
              ...
              if ("\n" != n && "\r" != n)
                if ("#" != n)
                  if ("$" != n) {
                    if ((97 <= s && s <= 122) || (65 <= s && s <= 90) || "_" == n) {
                      ...
                      if (a >= 0) {
                        ...
                        (O.startsWith(t, _, J._$cs)
                          ? ((h._$RP = B._$hs), (h._$4P = O.createString(t, _, a - _)))
                          : O.startsWith(t, _, J._$ar)
                            ? ((h._$4P = O.createString(t, _ + 7, a - _ - 7)),
                              O.startsWith(t, _ + 7, "ANCHOR_X")
                                ? (h._$RP = B._$xs)
                                : O.startsWith(t, _ + 7, "ANCHOR_Y")
                                  ? (h._$RP = B._$us)
                                  : O.startsWith(t, _ + 7, "SCALE_X")
                                    ? (h._$RP = B._$qs)
                                    : O.startsWith(t, _ + 7, "SCALE_Y")
                                      ? (h._$RP = B._$Ys)
                                      : O.startsWith(t, _ + 7, "X")
                                        ? (h._$RP = B._$ws)
                                        : O.startsWith(t, _ + 7, "Y") && (h._$RP = B._$Ns))
                            : ((h._$RP = B._$Fr), (h._$4P = O.createString(t, _, a - _))),
                          i.motions.push(h));
                        var l = 0,
                          $ = [];
                    ...
                    if (a >= 0)
                      for (
                        a == _ + 4 && "f" == Q(t, _ + 1) && "p" == Q(t, _ + 2) && "s" == Q(t, _ + 3) && (f = !0),
                          o = a + 1;
                        o < r && "\r" != (n = Q(t, o)) && "\n" != n;
                        ++o
                      )
            ...
            for (var h, l, $, u = r * n, p = 0, f = 0, c = 0, d = 0, g = 0, y = 0, m = !1, T = o; T < u; T += n) {
              ...
              if (((v = i[T]), (L = i[T + 1]), (P = v * _), (S = L * a), P < 0 || S < 0 || _ <= P || a <= S)) {
                  ...
                  if (v <= 0)
                    if (L <= 0) {
                      var x = s[2 * (0 + 0 * M)],
                        ...
                        U = 0.5 * (L - -2);
                      B + U <= 1
                        ? ((e[T] = C + (b - C) * B + (D - C) * U), (e[T + 1] = N + (F - N) * B + (R - N) * U))
                        : ((e[T] = x + (D - x) * (1 - B) + (b - x) * (1 - U)),
                ...
                ((l = P - (0 | P)),
                  ...
                  (h = 2 * ((0 | P) + (0 | S) * (_ + 1))),
                  l + $ < 1
                    ? ((e[T] = s[h] * (1 - l - $) + s[h + 2] * l + s[h + 2 * (_ + 1)] * $),
                      (e[T + 1] = s[h + 1] * (1 - l - $) + s[h + 3] * l + s[h + 2 * (_ + 1) + 1] * $))
                    : ((e[T] =
                        s[h + 2 * (_ + 1) + 2] * (l - 1 + $) + s[h + 2 * (_ + 1)] * (1 - l) + s[h + 2] * (1 - $)),
                      (e[T + 1] =
                        s[h + 2 * (_ + 1) + 3] * (l - 1 + $) + s[h + 2 * (_ + 1) + 1] * (1 - l) + s[h + 3] * (1 - $))));
            }
          }),
            ...
            for (
              ...
              (at._$ts
                ...
                : ((_ = e[m] * c),
                  ...
                  ($ = 2 * ((0 | _) + (0 | a) * (c + 1)))),
                u + p < 1
                  ? ((r[m] = y[$] * (1 - u - p) + y[$ + 2] * u + y[$ + 2 * (c + 1)] * p),
                    (r[m + 1] = y[$ + 1] * (1 - u - p) + y[$ + 3] * u + y[$ + 2 * (c + 1) + 1] * p))
                  : ((r[m] = y[$ + 2 * (c + 1) + 2] * (u - 1 + p) + y[$ + 2 * (c + 1)] * (1 - u) + y[$ + 2] * (1 - p)),
                    (r[m + 1] =
                      y[$ + 2 * (c + 1) + 3] * (u - 1 + p) + y[$ + 2 * (c + 1) + 1] * (1 - u) + y[$ + 3] * (1 - p))));
          }),
        ...
        ((at._$yr = !1),
            ...
            try {
              ...
              if (!e && (W.prototype._$2b.call(this, t), this._$32())) {
                ...
                if ((r._$8r == W._$ur && (r._$8r = t.getBaseDataIndex(o)), r._$8r < 0))
                  ...
                  (null == n || s._$x2()
                    ? (r._$AT = !1)
                    : (n._$nb(t, s, r._$Cr, r._$hr, this._$d0, U._$i2, U._$No), (r._$AT = !0)),
          ...
          (mt._$cr = function (t, i) {
            return (
              null == t || t._$yL() < i.length
                ? ((t = mt._$9r(2 * i.length)), t.put(i), t._$oT(0))
                : (t.clear(), t.put(i), t._$oT(0)),
              t
            );
          }),
          (mt._$mb = function (t, i) {
            return (
              null == t || t._$yL() < i.length
                ? ((t = mt._$vb(2 * i.length)), t.put(i), t._$oT(0))
                : (t.clear(), t.put(i), t._$oT(0)),
              t
            );
          }),
          ...
          (mt.prototype.createFramebuffer = function () {
            ...
            return (
              ...
              { framebuffer: e, renderbuffer: r, texture: at.fTexture[this.glno] }
            );
          }),
        ...
        ((St.prototype._$bT = function () {
          ...
          (Lt._$kT = [
            ...
            0.485651, 0.496425, 0.507124, 0.517745, 0.528287, 0.538748, 0.549126, 0.559421, 0.56963, 0.579752, 0.589785,
            0.599728, 0.609579, 0.619337, 0.629, 0.638567, 0.648036, 0.657406, 0.666676, 0.675843, 0.684908, 0.693867,
            0.70272, 0.711466, 0.720103, 0.72863, 0.737045, 0.745348, 0.753536, 0.76161, 0.769566, 0.777405, 0.785125,
            0.792725, 0.800204, 0.807561, 0.814793, 0.821901, 0.828884, 0.835739, 0.842467, 0.849066, 0.855535,
            0.861873, 0.868079, 0.874153, 0.880093, 0.885898, 0.891567, 0.897101, 0.902497, 0.907754, 0.912873,
            0.917853, 0.922692, 0.92739, 0.931946, 0.936359, 0.940629, 0.944755, 0.948737, 0.952574, 0.956265, 0.959809,
            0.963207, 0.966457, 0.96956, 0.972514, 0.97532, 0.977976, 0.980482, 0.982839, 0.985045, 0.987101, 0.989006,
            0.990759, 0.992361, 0.993811, 0.995109, 0.996254, 0.997248, 0.998088, 0.998776, 0.999312, 0.999694,
            0.999924, 1,
          ]),
          ...
          (Et.setup = function () {
            ...
            var i,
              e = Et.USER_AGENT,
              r = (Et.SYSTEM_INFO = { userAgent: e });
            if ((i = e.indexOf("iPhone OS ")) >= 0)
              ((r.os = "iPhone"), (r._isIPhone = !0), (r.version = t(e, i + "iPhone OS ".length)));
              ...
              (i = e.indexOf("Android")) >= 0
                ? ((r.os = "Android"), (r._isAndroid = !0), (r.version = t(e, i + "Android ".length)))
                : ((r.os = "-"), (r.version = -1));
          }),
          (window.UtSystem = w),
          (window.UtDebug = _),
        ...
        for (var e = 0; e < this.models.length; e++)
          this.models[e].hitTest($.default.HIT_AREA_HEAD, t, i)
            ...
            : this.models[e].hitTest($.default.HIT_AREA_BODY, t, i)
              ? ($.default.DEBUG_LOG && console.log("Tap body. models[" + e + "]"),
    ...
    ((o.prototype = new n.L2DBaseModel()),
                ...
                if (r.isTexLoaded) {
                  ...
                  if (
                    ...
                    null != r.modelSetting.getPhysicsFile()
                      ? r.loadPhysics(r.modelHomeDir + r.modelSetting.getPhysicsFile())
                      : (r.physics = null),
                    null != r.modelSetting.getPoseFile()
                      ? r.loadPose(r.modelHomeDir + r.modelSetting.getPoseFile(), function () {
                  ...
                  for (var t = 0; t < r.modelSetting.getInitPartsVisibleNum(); t++)
                    r.live2DModel.setPartsOpacity(
                      r.modelSetting.getInitPartsVisibleID(t),
                      r.modelSetting.getInitPartsVisibleValue(t)
                    );
      ...
      (o.prototype.update = function () {
        ...
        (this.live2DModel.loadParam(),
          ...
          this.live2DModel.addToParamFloat("PARAM_ANGLE_X", Number(15 * Math.sin(e / 6.5345)), 0.5),
          this.live2DModel.addToParamFloat("PARAM_ANGLE_Y", Number(8 * Math.sin(e / 3.5345)), 0.5),
          this.live2DModel.addToParamFloat("PARAM_ANGLE_Z", Number(10 * Math.sin(e / 5.5345)), 0.5),
          this.live2DModel.addToParamFloat("PARAM_BODY_ANGLE_X", Number(4 * Math.sin(e / 15.5345)), 0.5),
          this.live2DModel.setParamFloat("PARAM_BREATH", Number(0.5 + 0.5 * Math.sin(e / 3.2345)), 1),
      ...
      (o.prototype.hitTestCustom = function (t, i, e) {
        return "head" == t
          ? this.hitTestSimpleCustom(h.default.hit_areas_custom_head_x, h.default.hit_areas_custom_head_y, i, e)
          : "body" == t &&
              this.hitTestSimpleCustom(h.default.hit_areas_custom_body_x, h.default.hit_areas_custom_body_y, i, e);
      }));
  },
  function (t, i, e) {
    "use strict";
...
console.log(
  "%c Live2D %c https://www.live2d.com ",
  "color: #fff; margin: 1em 0; padding: 5px 0; background: #00a9e0;",
